  ...
  class MigrateAdminPage implements AdminPage {
    ...
    public function render(): void {
      ...
      <div class='wrap'>
        ...
        <p><?= esc_html__('If you are using Sim League Toolkit to build a website for an existing league then the tools here will help you migrate your existing data to get up and running quickly.',
