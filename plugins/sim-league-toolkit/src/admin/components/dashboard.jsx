...
export const Dashboard = () => {
    return (
        <>
            ...
            <p>
                {__('With this plugin you can manage a sim racing league using any WordPress theme or website. Here in the admin panel you can create championships or individual events for any of the supported games.', 'sim-league-toolkit')}
