<?php
   ...
   * Plugin URI:        https://devology.uk/sim-leauge-toolkit
   * Description:       A collection of blocks and admin pages to run and manage a league using almost any motor racing SIM or game
   * Version:           1.0.0
   * Requires at least: 6
   * Requires PHP:      8.3
   * Author:            Devology UK
   * Author URI:        https://devology.uk
   * License:           GPL v2 or later
   * License URI:       https://www.gnu.org/licenses/gpl-2.0.html
   * Update URI:        https://devology.uk/sim-leauge-toolkit
