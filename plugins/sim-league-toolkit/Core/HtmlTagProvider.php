<?php
    ...
    class HtmlTagProvider {
        ...
        public static function theAdminInputField(HtmlTagProviderInputConfig $config): void {
            ...
            <tr>
                <th scope='row'>
                    <label class='form-label' for='<?= $config->name ?>' <?= self::errorLabelClass($config->error) ?>
                           title='<?= $config->tooltip ?>'><?= $config->label ?></label>
                </th>
                <td>
                    <input type='<?= $config->type ?>'
                           ...
                           title='<?= $config->tooltip ?>'
                            ...
                            <?= $config->submitOnChange ? 'onchange="this.form.submit()"' : '' ?>
                            <?= $config->type === 'checkbox'? checked($config->checked, true, false): '' ?>
                    />
                    <?php
            ...
            <tr>
                <th scope='row'>
                    <label class='form-label'
                           for='<?= $name ?>' <?= self::errorLabelClass($error) ?>><?= $label ?></label>
                </th>
                <td>
